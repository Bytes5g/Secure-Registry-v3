...
- إضافة طبقة حوكمة مرجعية (`governance`) لمجالات الأمن القومي والتهديدات والقوانين والمواد وجهات الاختصاص.
...
- اعتماد حقل اسم عام واحد في الإضافات الجديدة عندما تكون البيانات عربية بالكامل بدل تكرار حقول `ar/en`.
